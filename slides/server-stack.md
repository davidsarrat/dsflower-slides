...
<svg viewBox="0 -15 720 355" style="width: 100%; max-height: 430px;">
  ...
  <g v-click>
    ...
    <text x="367" y="123" text-anchor="middle" fill="#b0b8c0" font-family="Roboto Mono" font-size="2.2">reaches the SuperLink via the DSI tunnel</text>
  </g>
  ...
  <g v-click>
    ...
    <text x="367" y="157" text-anchor="middle" fill="#e0d8d0" font-family="Roboto Mono" font-size="2.8">One PyTorch venv (via uv)</text>
    <text x="367" y="174" text-anchor="middle" fill="#FFD000" font-family="Roboto Mono" font-size="2.6">torch · torchvision · <tspan class="g-term" data-g="Opacus" style="cursor:pointer;">Opacus</tspan> · image readers</text>
  </g>
  ...
  <g v-click>
    ...
    <text x="367" y="260" text-anchor="middle" fill="#66ddaa" font-family="Roboto Mono" font-size="2.2" class="g-term" data-g="Differential Privacy" style="cursor:pointer;">Differential Privacy · Disclosure control</text>
  </g>
